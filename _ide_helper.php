...
namespace Demindo\MulticraftApi { 
    ...
    class Multicraft {
        ...
        {
            return \Demindo\MulticraftApi\MulticraftApi::setOptions($options);
        }
         ...
         * @static 
         */ 
        public static function setCredentials($url, $user = null, $key = null)
        {
            return \Demindo\MulticraftApi\MulticraftApi::setCredentials($url, $user, $key);
        }
        ...
        {
            return \Demindo\MulticraftApi\MulticraftApi::call($method, $params);
        }
        ...
        {
            return \Demindo\MulticraftApi\MulticraftApi::send($url, $query);
        }
        ...
        {
            return \Demindo\MulticraftApi\MulticraftApi::rawResponse();
        }
...
namespace  { 
    ...
    class Multicraft extends \Demindo\MulticraftApi\Multicraft {}
