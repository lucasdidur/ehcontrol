<header class="navbar navbar-fixed-top navbar-shadow">
    ...
    <form class="navbar-form navbar-left navbar-search alt" role="search">
        <div class="form-group">
            <input type="text" class="form-control" placeholder="Procurar..." value="Procurar...">
        </div>
    </form>
    <ul class="nav navbar-nav navbar-right">
                        ...
                        <div class="panel-body panel-scroller scroller-navbar pn">
                            <div class="tab-content br-n pn">
                                <div id="nav-tab1" class="tab-pane alerts-widget active" role="tabpanel">
                                    ...
                                    <div class="media">
                                        <a class="media-left" href="#"> <span
                                                    class="glyphicon glyphicon-shopping-cart text-success"></span>
                                        </a>
                                    ...
                                    <ul class="media-list" role="menu">
                                        <li class="media">
                                            <a class="media-left" href="#">
                                                {!! Html::image('assets/img/avatars/5.jpg', "avatar", ['class' => 'mw40']) !!}
                                            </a>
                                        ...
                                        <li class="media">
                                            <a class="media-left" href="#">
                                                {!! Html::image('assets/img/avatars/2.jpg', "avatar", ['class' => 'mw40']) !!}
                                            </a>
                                        ...
                                        <li class="media">
                                            <a class="media-left" href="#">
                                                {!! Html::image('assets/img/avatars/3.jpg', "avatar", ['class' => 'mw40']) !!}
                                            </a>
                                        ...
                                        <li class="media">
                                            <a class="media-left" href="#">
                                                {!! Html::image('assets/img/avatars/4.jpg', "avatar", ['class' => 'mw40']) !!}
                                            </a>
        ...
        <li class="dropdown menu-merge">
            <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                {!! Html::image('assets/img/avatars/5.jpg', "avatar", ['class' => 'mw30 br64']) !!}
                <span class="hidden-xs pl15"> {{ Auth::user()->first_name . ' ' . Auth::user()->last_name }} </span>
            ...
            <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
                ...
                <li class="dropdown-footer">
                    <a href="{{ URL::to('auth/logout') }}" class="">
